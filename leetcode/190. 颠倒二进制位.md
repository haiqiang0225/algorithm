...
<div class="notranslate"><p>颠倒给定的 32 位无符号整数的二进制位。</p>
...
public class Solution {
    ...
    @Test
    public void test0() {
        int res = new Solution().reverseBits(-3);
        assert res == -1073741825;
    }

    @Test
    public void test1() {
        int res = new Solution().reverseBits(0b00000010100101000001111010011100);
