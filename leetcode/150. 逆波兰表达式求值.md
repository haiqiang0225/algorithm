...
<div class="content__1Y2H"><div class="notranslate"><p>根据<a href="https://baike.baidu.com/item/%E9%80%86%E6%B3%A2%E5%85%B0%E5%BC%8F/128437"> 逆波兰表示法</a>，求表达式的值。</p>
...
public class Solution {
    ...
    public int evalRPN(String[] tokens) {
        ...
        // 发现leetcode居然不让用Pattern，好吧，也一样
        //Pattern numsPattern = Pattern.compile("[0-9]+");
        // 我们的栈
        String[] stack = new String[tokens.length + 1];
        int top = -1;
        for (String s : tokens) {
            // 如果是数值,入栈
            if (!"+".equals(s) && !"-".equals(s) && !"*".equals(s) && !"/".equals(s)) {
                ...
                stack[++top] = Integer.toString(tmp);
